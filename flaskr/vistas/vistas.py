...
from ..models import db, Cancion, CancionSchema, Usuario, UsuarioSchema, Album, AlbumSchema
...
class VistaSignIn(Resource):
    ...
    def post(self):
        ...
        token_de_acceso = create_access_token(identity=nuevo_usuario.nombre)
